...
export default function ProjectTicketsChat({
  ...
  return (
    <div className="flex flex-col h-[750px] max-h-[82vh] rounded-2xl border border-[#D9C7B8] bg-cream overflow-hidden shadow-card animate-fade-in">
      
      {/* ── Top Bar: Header & Filters ─────────────────────── */}
      <div className="p-3.5 sm:p-4 bg-beige/60 border-b border-[#D9C7B8] flex flex-wrap items-center justify-between gap-3 shrink-0">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-xl bg-warm-brown text-white flex items-center justify-center shadow-xs">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 rounded-full bg-warm-brown/10 text-warm-brown text-[11px] font-bold border border-warm-brown/20">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {/* Type Filter */}
          <select
            className="input-base py-1.5 px-3 text-xs w-auto bg-white border-gray-200 font-medium"
            value={typeFilter}
          ...
          <button
            ...
            disabled={refreshing}
            className="p-1.5 rounded-xl bg-white border border-gray-200 text-gray-600 hover:text-black hover:bg-light-blue/40 transition-all shadow-xs"
            title={t('common.refresh', { defaultValue: 'Refresh Feed' })}
          >
            <svg className={`w-4 h-4 ${refreshing ? 'animate-spin' : ''}`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
          ...
          <Button
            type="button"
            className="w-auto py-1.5 px-3.5 text-xs shadow-xs"
            onClick={() => openCreateModal('INSTRUCTION')}
          >
            + {t('tickets.new_request', { defaultValue: 'New Request' })}
          </Button>
        </div>
      </div>
      ...
      <div className="p-3 sm:p-4 bg-white border-t border-[#D9C7B8] flex flex-wrap items-center justify-between gap-2.5 shrink-0">
        <div className="flex flex-wrap items-center gap-1.5">
          <span className="text-[11px] font-semibold text-gray-500 hidden sm:inline mr-1">
            {t('tickets.quick_actions', { defaultValue: 'Quick Action:' })}
          </span>
          <button
            type="button"
            onClick={() => openCreateModal('EXPENSE')}
            className="px-2.5 py-1.5 rounded-xl bg-warm-brown/10 hover:bg-warm-brown/20 text-warm-brown text-xs font-semibold transition-colors flex items-center gap-1 border border-warm-brown/20"
          >
          ...
          <button
            type="button"
            onClick={() => openCreateModal('INSTRUCTION')}
            className="px-2.5 py-1.5 rounded-xl bg-light-blue/40 hover:bg-light-blue text-gray-800 text-xs font-semibold transition-colors flex items-center gap-1 border border-light-blue"
          >
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded-xl bg-teal-50 hover:bg-teal-100 text-teal-800 text-xs font-semibold transition-colors flex items-center gap-1 border border-teal-200"
          >
          ...
          <button
            ...
            className="px-2.5 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-semibold transition-colors flex items-center gap-1 border border-slate-200"
          >
            📋 + {t('tickets.types.site_report', { defaultValue: 'Site Report' })}
          </button>
        </div>

        <Button
          type="button"
          className="w-full sm:w-auto py-2.5 px-6 text-xs font-bold shadow-sm"
          onClick={() => openCreateModal('INSTRUCTION')}
        >
