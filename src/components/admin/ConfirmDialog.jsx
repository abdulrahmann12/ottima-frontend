  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={title} size="sm">
      ...
      <div className="flex items-start gap-4">
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-red-50 border border-red-200
        ...
        <p className="text-gray-700 text-sm leading-relaxed flex-1 pt-1.5 font-medium">
          {message}
        </p>
      </div>
      ...
      <div className="flex items-center justify-end gap-3 mt-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl
            ...
            focus:outline-none focus:ring-2 focus:ring-red-500/50 active:scale-[0.98] shadow-sm"
        >
          {loading && (
